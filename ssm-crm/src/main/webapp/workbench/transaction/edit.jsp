...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	<script type="text/javascript">
		...
		*/
		...
		function editTran(){
			var id = sessionStorage.getItem("tranId");
			...
			$.ajax({
				...
				success : function (data) {
					...
					$("#edit-customerName").val(data.t.customerId);
...
<body>
	...
	<form action="workbench/transaction/update.do" id="tranForm" method="post"
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time1"
					   id="edit-expectedDate" name="expectedDate"
					   readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control"
					   id="edit-customerName" name="customerName"
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 70%;">
				<textarea class="form-control" rows="3"
						  id="edit-contactSummary" name="contactSummary"></textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time2"
					   id="edit-nextContactTime" name="nextContactTime"
					   readonly>
			</div>
		</div>
