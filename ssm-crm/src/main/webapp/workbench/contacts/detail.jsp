	...
	$(function(){
			...
			$.ajax({
				...
				success : function (data) {
					...
					if(data.success) {
						...
						var html = "";
						html += '<div class="remarkDiv" id="' + data.cr.id +
								'" style="height: 60px;">';
						...
						html +=
								'<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.fullname}${c.appellation}-${c.customerId}</b> <small style="color: gray;" id="e' + data.cr.id + '"> ' + data.cr.createTime + ' 由' + data.cr.createBy + '</small>';
						html +=
		...
		$("#aname").keydown(function (event) {
			if(event.keyCode == 13) {
				...
				$.ajax({
					url : "workbench/contacts/getActivityByNameAndNotByContactsId.do",
					data : {
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data, function (i, n) {
					...
					html += '<div class="remarkDiv" id="' + n.id +
							'" style="height: 60px;"> ';
					html += '<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data, function (i, n) {
					...
					html += '<tr>';
					html += '<td><a style="text-decoration: none; cursor:pointer;" onclick="window.location.href=\'workbench/transaction/detail.do?id=' + n.id + '\'">${c.fullname}-' + n.name +'</a></td>';
					html += '<td>' + n.money + '</td>';
					html += '<td>' + n.stage + '</td>';
...
<%--		<!-- 备注1 -->--%>
		<%--<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
				<font color="gray">联系人</font> <font color="gray">-</font> <b>李四先生-</b> <small style="color: gray;"> 2017-01-22 10:10:10 由zhangsan</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
...
<%--		<div class="remarkDiv" style="height: 60px;">
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="workbench/transaction/add.do?contactsName=${c.fullname}&contactsId=${c.id}" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建交易</a>
			</div>
		</div>
	</div>
